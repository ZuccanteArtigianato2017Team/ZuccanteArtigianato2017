...
Bluetooth *blue = new Bluetooth(A3, A2);
...
/**
//MA GAS!P! L'ialiano * 	@brief verifica in anzi tutto che il robot sia orientato in modo giusto
...
void setup()
{
  ...
  blue->setrxPin(A3);
  blue->settxPin(A2);
  blue->setBaudrate(9600);
  blue->setName("Difensore");
  blue->setupBluetooth();
  Serial.println("Ciao");
  /*
